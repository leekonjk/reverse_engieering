...
public final class agy implements KeyListener {
    private final KeyListener a;

    public agy(KeyListener keyListener) {
        this.a = keyListener;
    }
    ...
    */
    public final boolean onKeyDown(android.view.View r4, android.text.Editable r5, int r6, android.view.KeyEvent r7) {
        /*
            ...
            goto L1a
        Lb:
            boolean r0 = defpackage.zz.d(r5, r7, r1)
            goto L14
        L10:
            boolean r0 = defpackage.zz.d(r5, r7, r2)
        L14:
            if (r0 == 0) goto L1a
        ...
        L23:
            return r2
        */
        throw new UnsupportedOperationException("Method not decompiled: defpackage.agy.onKeyDown(android.view.View, android.text.Editable, int, android.view.KeyEvent):boolean");
    }
