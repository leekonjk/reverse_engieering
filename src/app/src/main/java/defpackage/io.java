...
public final class io {
    ...
    public static final ColorStateList b(Context context, int i) {
        int b = ni.b(context, R.attr.colorControlHighlight);
        return new ColorStateList(new int[][]{ni.a, ni.c, ni.b, ni.e}, new int[]{ni.a(context, R.attr.colorButtonNormal), zk.b(b, i), zk.b(b, i), i});
    }

    public static final LayerDrawable c(mz mzVar, Context context, int i) {
        BitmapDrawable bitmapDrawable;
        BitmapDrawable bitmapDrawable2;
        BitmapDrawable bitmapDrawable3;
        int dimensionPixelSize = context.getResources().getDimensionPixelSize(i);
        Drawable c = mzVar.c(context, R.drawable.abc_star_black_48dp);
        Drawable c2 = mzVar.c(context, R.drawable.abc_star_half_black_48dp);
    ...
    public static final void d(Drawable drawable, int i, PorterDuff.Mode mode) {
        ...
        mutate.setColorFilter(ip.b(i, mode));
    }
}
