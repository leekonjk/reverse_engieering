...
public class bxu extends lf {
    ...
    public bxu(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 0);
    }

    public bxu(Context context, AttributeSet attributeSet, int i) {
        ...
        this.a = true;
        this.b = false;
        TypedArray c = bxy.c(context, attributeSet, bxw.a, i, 0);
        this.i = c.getInt(1, this.i);
        Drawable drawable = c.getDrawable(0);
        if (drawable != null) {
            setForeground(drawable);
        }
        this.a = c.getBoolean(2, true);
        c.recycle();
    }
}
