...
public class iw extends RadioButton implements agl {
    private final in a;
    private final ii b;
    private final jp c;
    private ayn d;
    ...
    public iw(Context context, AttributeSet attributeSet) {
        ...
        this.a = inVar;
        inVar.b(attributeSet, R.attr.radioButtonStyle);
        ii iiVar = new ii(this);
        this.b = iiVar;
        iiVar.b(attributeSet, R.attr.radioButtonStyle);
        jp jpVar = new jp(this);
        this.c = jpVar;
        jpVar.g(attributeSet, R.attr.radioButtonStyle);
        c().m(attributeSet, R.attr.radioButtonStyle);
    }
