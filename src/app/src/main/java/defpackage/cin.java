...
public enum cin {
    ...
    static {
        ...
        for (cin cinVar : values()) {
            if (hashMap.put(Character.valueOf(cinVar.G), cinVar) != null) {
                throw new IllegalStateException("duplicate format character: ".concat(String.valueOf(String.valueOf(cinVar))));
            }
        }
